...
namespace FeladatAPI.Controllers
{
    ...
    public class BooksController(BooksContext context, IMapper mapper) : ControllerBase
    {
        [HttpGet]
        ...
        {
            var booksWithAuthors = await context.Books.Include(b => b.Author).ToListAsync();
